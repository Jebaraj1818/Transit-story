...
import { CULTURAL_HERITAGE_DATA } from '../data/culturalHeritage';

export default function CulturalHeritageDetails() {
  const navigate = useNavigate();
  const [searchParams] = useSearchParams();
  const shouldReduceMotion = useReducedMotion();
  const { heroSlides, culturalJourneys, eyebrow, heroTitle, heroTagline, intro, bottomCta } =
  ...
  return (
    <div className="bg-[#FAF7F0] text-charcoal min-h-screen">
      {/* ========================================================================= */}
      {/* 2 & 3. LARGE FULL-WIDTH HERO SLIDESHOW (AUTOPLAYING, 70-80vh DESKTOP)     */}
      {/* ========================================================================= */}
      <section
        ...
        aria-label="Cultural and Heritage Journeys Slideshow"
      >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-8">
            ...
            <div className="max-w-[340px] sm:max-w-md md:max-w-[540px]">
              ...
              <div className="flex items-center gap-2 text-xs uppercase tracking-editorial text-ivory/80 font-sans">
                ...
                <span className="font-semibold text-ivory">{activeSlide.temple}</span>
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  aria-label="Previous temple slide"
                >
      ...
      <div className="py-14 sm:py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* ========================================================================= */}
          {/* 5 & 6. FEATURED CULTURAL JOURNEYS — ALTERNATING EDITORIAL LAYOUT          */}
          {/* ========================================================================= */}
          <section className="py-14 sm:py-20 space-y-20 sm:space-y-28">
            {culturalJourneys.map((journey, idx) => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        style={{ objectPosition: journey.objectPosition || 'center 35%' }}
                      />
                  ...
                  >
                    ...
                    <h3 className="font-serif text-3xl sm:text-4xl lg:text-[2.6rem] font-normal text-forest leading-[1.1] tracking-tight group-hover:text-forest-900 transition-colors">
                      <Link to={`/tours/${journey.slug}`} className="hover:text-forest-900 focus-visible:outline-gold">
                        {journey.title}
                      </Link>
                    </h3>
                    ...
                    {/* Small detail line if available */}
                    {journey.details && (
                    ...
                    {/* Links: Explore Journey and Plan */}
                    <div className="pt-3 flex flex-wrap items-center gap-5 sm:gap-6">
                      ...
                      <Link
                        to={`/plan-your-journey?destination=${encodeURIComponent(journey.title)}`}
                        state={{
          ...
          {/* ========================================================================= */}
          {/* 9. END OF CATEGORY PAGE — COMPACT FINAL ENQUIRY CTA                       */}
          {/* ========================================================================= */}
            ...
            <div className="bg-[#173A2D] text-[#F5F0E5] rounded-sm p-8 sm:p-12 md:p-16 text-center relative overflow-hidden shadow-xl border border-[#1F4C3C]">
              ...
              <div className="relative z-10 max-w-2xl mx-auto">
                <div className="inline-flex items-center gap-2 px-3.5 py-1 bg-white/10 rounded-sm text-[10px] sm:text-xs uppercase tracking-kicker text-gold mb-4 border border-white/10 font-medium">
                  ...
                  <span>Cultural Journeys Arranged On Request</span>
                </div>
                ...
                <Link
                  to="/plan-your-journey?destination=Cultural%20%26%20Heritage%20Journey"
                  state={{
                    destination: 'Cultural & Heritage Journey',
                    category: 'Cultural & Heritage Journey'
                  }}

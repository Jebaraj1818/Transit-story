    ...
    <div className="min-h-screen pt-5 sm:pt-8 md:pt-12 pb-16 sm:pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-8 sm:mb-12">
          <div className="flex items-center justify-between gap-4 pb-2.5 mb-3.5 sm:mb-4 border-b border-[#E3DCBF]/80 text-[10px] sm:text-xs uppercase tracking-[0.2em] text-earth font-medium">
            <div className="flex items-center gap-2">
              ...
              <span>Service Terms • Transit Story</span>
            </div>
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-sm sm:text-base text-charcoal-muted leading-relaxed font-normal">
              General guidelines and terms governing travel curation, logistical coordination, and journey arrangements with Transit Story.
            </p>
          </div>
        </header>
        ...
        <div className="p-4 sm:p-5 bg-[#FAF6EC] border border-[#E0D7BD] rounded-sm mb-8 text-xs text-charcoal-muted leading-relaxed">
          ...
          <p>
            This document represents a structured operational overview for Transit Story's bespoke travel model. Formal legal terms and conditions will be ratified prior to enterprise-level transaction processing.
          </p>
        </div>
        ...
        <div className="space-y-8 sm:space-y-10 text-charcoal-muted text-sm sm:text-[15px] leading-relaxed">
          <section className="space-y-3">
            ...
            <p>
              Transit Story coordinates bespoke travel arrangements across South India, including private vehicle fleets, verified accommodations, academic industrial visits (IVs), and curated day-wise itinerary flows. We act as a travel planning and logistics coordination service.
            </p>
          </section>
